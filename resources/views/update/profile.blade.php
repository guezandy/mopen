    ...
    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 Android">
        <div class="panel panel-default item">
            <div class="panel-heading">
                <a href="{{ url('profile', ['username'=>$user->username, 'id' => $post['post']->post_id])}}">
                    <img class="img-responsive item-img" src="{!! $base64 !!}" alt="Work 2">
                </a>    
            </div>
            <div class="panel-body">
                <a href="{{ url('profile', ['username'=>$user->username, 'id' => $post['post']->post_id])}}"><h4 class="item-title">{{$post['post']->name}}</h4></a>
